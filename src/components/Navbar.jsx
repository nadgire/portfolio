...
const Navbar = () => {
   ...
   const navMenuArr = [{ title: "Home", href: "/home", menuIcon: IoHome },
   ...
   return (
      <div className='shadow-sm w-full fixed bg-white whitespace-nowrap z-50 '>
         <div className='flex justify-between items-center mx-auto max-w-[80%] h-16'>
            <div className='w-16 h-5 flex flex-col items-center justify-center'>
                     ...
                     navMenuArr.map((x) => {
                        return (
                           <li key={x.title} className='hover:scale-125 transition-all duration-500 hover:text-blue-900'>
                              <NavLink to={x.href} className='flex gap-2' style={({ isActive }) => ({
