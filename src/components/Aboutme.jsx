...
const Aboutme = () => {
    ...
    const handleMouseOut = (ref, setTilt) => {
                ...
                <div className='flex flex-col md:flex-row'>
                    <div className='hidden lg:block w-1/3 h-auto relative image-container'>
                        <img ref={tiltRef1}
                            ...
                            onMouseOver={() => handleMouseOver(tiltRef1)}
                            onMouseOut={() => handleMouseOut(tiltRef1, setTilt1)}
                            style={{
                                transform: `perspective(500px) rotateX(${tilt1.y}deg) rotateY(${tilt1.x}deg)`,
                ...
                <div className='flex'>
                    <div className='hidden lg:block w-1/3 h-auto relative'>
                        <img ref={tiltRef2}
                            ...
                            onMouseOver={() => handleMouseOver(tiltRef2)}
                            onMouseOut={() => handleMouseOut(tiltRef2, setTilt2)}
                            style={{
                                transform: `perspective(500px) rotateX(${tilt2.y}deg) rotateY(${tilt2.x}deg)`,
